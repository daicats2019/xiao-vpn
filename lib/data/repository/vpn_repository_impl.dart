...
class VpnRepositoryImpl implements VpnRepository {
  ...
  @override
  Future<String> getVpnServerConfig(int? serverId) async {
    final cached = _local.getVpnServerById(serverId);
    if (cached == null) {
      throw Exception('Error! Cannot find $serverId');
    }
    ...
    cached.copyWith(ovpnConfig: ovpnConfig);
