...
abstract class $VpnServerModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(9) String? lat,
      @HiveField(10) String? lon});
}
...
class _$_VpnServerModel implements _VpnServerModel {
  const _$_VpnServerModel(
      ...
      @HiveField(9) this.lat,
      @HiveField(10) this.lon});

  factory _$_VpnServerModel.fromJson(Map<String, dynamic> json) =>
      _$$_VpnServerModelFromJson(json);
  ...
  @override
  String toString() {
    return 'VpnServerModel(id: $id, ovpn: $ovpn, flag: $flag, vip: $vip, ip: $ip, city: $city, ovpnConfig: $ovpnConfig, country: $country, region: $region, lat: $lat, lon: $lon)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, ovpn, flag, vip, ip, city,
      ovpnConfig, country, region, lat, lon);
...
abstract class _VpnServerModel implements VpnServerModel {
  const factory _VpnServerModel(
      ...
      @HiveField(8) final String? region,
      @HiveField(9) final String? lat,
      @HiveField(10) final String? lon}) = _$_VpnServerModel;
